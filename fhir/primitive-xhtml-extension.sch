...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:valueXhtml) &gt;= 1">valueXhtml: minimum cardinality of 'valueXhtml' is 1</sch:assert>
      <sch:assert test="count(f:valueXhtml) &lt;= 1">valueXhtml: maximum cardinality of 'valueXhtml' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
