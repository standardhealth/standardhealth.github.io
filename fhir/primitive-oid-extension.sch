...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:valueOid) &gt;= 1">valueOid: minimum cardinality of 'valueOid' is 1</sch:assert>
      <sch:assert test="count(f:valueOid) &lt;= 1">valueOid: maximum cardinality of 'valueOid' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
