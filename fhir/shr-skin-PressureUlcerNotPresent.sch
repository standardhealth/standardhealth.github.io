...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:modifierExtension</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Condition/f:modifierExtension/f:extension</sch:title>
    <sch:rule context="f:Condition/f:modifierExtension/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
