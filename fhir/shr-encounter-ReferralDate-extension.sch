...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      ...
      <sch:assert test="count(f:valueDate) &gt;= 1">valueDate: minimum cardinality of 'valueDate' is 1</sch:assert>
      <sch:assert test="count(f:valueDate) &lt;= 1">valueDate: maximum cardinality of 'valueDate' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
